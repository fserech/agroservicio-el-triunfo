...
export class ProductosService {
  ...
  update(id: number, d: Partial<Producto>): Observable<Producto> {
    return this.http.put<Producto>(`${API}/productos/${id}`, d);
  }
...
export class ClientesService {
  ...
  create(d: Partial<Cliente>): Observable<Cliente> {
    return this.http.post<Cliente>(`${API}/clientes`, d);
  }

  update(id: number, d: Partial<Cliente>): Observable<Cliente> {
    return this.http.put<Cliente>(`${API}/clientes/${id}`, d);
  }
...
export class ProveedoresService {
  ...
  create(d: Partial<Proveedor>): Observable<Proveedor> {
    return this.http.post<Proveedor>(`${API}/proveedores`, d);
  }

  update(id: number, d: Partial<Proveedor>): Observable<Proveedor> {
    return this.http.put<Proveedor>(`${API}/proveedores/${id}`, d);
  }
...
export class ConfiguracionService {
  ...
  save(config: { clave: string; valor: string }[]): Observable<any> {
    return this.http.put(`${API}/configuracion`, { config });
  }
}
