...
import { matSearchOutline, matAddOutline, matRemoveRedEyeOutline, matModeEditOutline, matShoppingCartOutline, matArrowDownwardOutline, matArrowUpwardOutline } from '@ng-icons/material-icons/outline';
...
@Component({
  selector: 'app-proveedores-list', standalone: true,
  imports: [HeaderComponent, CommonModule, FormsModule, NgIconComponent, DecimalPipe],
  providers: [provideIcons({ matSearchOutline, matAddOutline, matRemoveRedEyeOutline, matModeEditOutline, matShoppingCartOutline, matArrowDownwardOutline, matArrowUpwardOutline, bootstrapChevronLeft, bootstrapChevronRight, bootstrapChevronBarLeft, bootstrapChevronBarRight })],
  templateUrl: './proveedores-list.component.html', styleUrls: ['./proveedores-list.component.scss']
})
export class ProveedoresListComponent implements OnInit {
  ...
  items: Proveedor[] = []; load = false; searchText = '';
