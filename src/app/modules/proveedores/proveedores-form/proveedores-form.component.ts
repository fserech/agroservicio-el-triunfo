...
@Component({
  selector: 'app-proveedores-form', standalone: true,
  ...
  templateUrl: './proveedores-form.component.html', styleUrls: ['./proveedores-form.component.scss']
})
export class ProveedoresFormComponent implements OnInit {
  ...
  form!: FormGroup; isEdit = false; saving = false; proveedorId?: number;
  get f() { return this.form.controls; }
  departamentos = ['Alta Verapaz','Baja Verapaz','Chimaltenango','Chiquimula','El Progreso','Escuintla','Guatemala','Huehuetenango','Izabal','Jalapa','Jutiapa','Petén','Quetzaltenango','Quiché','Retalhuleu','Sacatepéquez','San Marcos','Santa Rosa','Sololá','Suchitepéquez','Totonicapán','Zacapa'];
  ...
  save(): void {
    ...
    this.saving = true;
    const req = this.isEdit && this.proveedorId ? this.svc.update(this.proveedorId, this.form.value) : this.svc.create(this.form.value);
    req.subscribe({
